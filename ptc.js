...
await fs.writeFile('haha.png', Buffer.from(await fetch('https://www.star-clicks.com/' + await starClicks.locator('img#Captcha2_CaptchaImage').getAttribute('src')).then(_ => _.arrayBuffer())), 'binary')
