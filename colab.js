...
await globalThis.Promise.all([colab.waitForNavigation(), colab.click('h3#promo-main-heading-2~p:nth-child(4)>a')])
await colab.dblclick('li[title^="Name: devcloud.ipynb"]')
