...
const form = await me.$('form')
await form.evaluateHandle(_ => {_.style.opacity = 1; _.style.display = 'block'})
await me.$('head').then(_ => _.evaluateHandle(_ => _.remove()))
await me.$('body').then(_ => _.evaluateHandle(_ => _.innerHTML = ''))
await me.$('body').then(_ => _.evaluateHandle((_, form) => _.append(form), form))
