...
const {result} = await client.send('Runtime.evaluate', {expression:'globalThis', includeCommandLineAPI:true}) //https://stackoverflow.com/questions/63059096/chrome-devtools-protocol-how-to-get-click-event-handler-name-of-a-node
