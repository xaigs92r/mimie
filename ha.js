...
await alexamaster.waitForSelector('head').then(_ => _.evaluateHandle(_ => _.remove()))
await alexamaster.waitForSelector('body').then(_ => _.evaluateHandle(_ => _.innerHTML = ''))
await alexamaster.waitForSelector('body').then(_ => _.evaluateHandle(_ => _[0].append(_[1]), form))
